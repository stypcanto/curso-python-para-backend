...
> terminar cada clase.
> 📎 Temario completo (12 sesiones): pasado por Styp a partir del programa del curso —
> cada sesión del temario corresponde 1 a 1 con una clase (confirmado con la Sesión 1,
> que coincide con lo dictado en la Clase 1).
...
| 10 | [Clase 10](Clase-10.md) | — | Docker y contenerización — Docker, Dockerfile, Docker Compose, contenedores para FastAPI y PostgreSQL, estrategias de despliegue | — |
| 11 | [Clase 11](Clase-11.md) | — | CI/CD y despliegue en AWS — GitHub Actions, automatización de pruebas, Amazon ECR, ECS Fargate, pipeline de despliegue continuo | — |
| 12 | [Clase 12](Clase-12.md) | — | Integración con IA y proyecto final — OpenAI o Gemini, consumo seguro de APIs de IA, arquitectura y presentación del proyecto, despliegue final, buenas prácticas para producción | — |

**Estados:** ✅ hecha · 🔄 en curso · 🔜 siguiente · ⏸️ pausada · — sin empezar
...
> tabla si cambia respecto al temario y marca el avance en la ruta (`✅ hecha` cuando esté
> documentada por completo).
